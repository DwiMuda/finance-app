      ...
      <form @submit.prevent="handleLogin" class="login-form">
        <div class="form-group">
          ...
          <div class="input-with-icon">
            ...
            <input id="username" v-model="form.username" type="text" placeholder="Masukkan username" required aria-label="Username" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-with-icon">
            ...
            <input id="password" v-model="form.password" type="password" placeholder="••••••••" required aria-label="Password" />
          </div>
        </div>
