            ...
            <div v-for="t in group.transactions" :key="t.id" class="tx-card glass-card">
              ...
              <div class="tx-right">
                ...
                <div class="tx-actions">
                  <button class="btn-icon" @click="openModal(t)" title="Edit" aria-label="Edit transaksi">
                  ...
                  <button class="btn-icon danger" @click="confirmDelete(t)" title="Hapus" aria-label="Hapus transaksi">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>
                  </button>
                </div>
              </div>
            </div>
